...
def compute_all_metrics(val_labels, preds, alpha, cluster_assignments=None):
    ...
    min_class_cond_cov = min(class_cond_cov)
    ...
    class_cov_metrics = {'undercov ratio': undercov_ratio, 
                         'worst_coverage': min_class_cond_cov, 
    ...
    # print('Worst Conditional Coverage:', min_class_cond_cov)
...
def truncated_classwise_conformal_plot(accuracy_matrix, totalcal_scores_all, totalcal_labels, totalcal_ranks, val_scores_all, val_labels, val_rank, alpha, truncated_gap,
                         num_classes, default_qhat=np.inf, regularize=False, exact_coverage=False):
    err_matrix = 1 - accuracy_matrix
    err_matrix = np.array(err_matrix)
    #print(err_matrix)
    ...
    return classwise_qhats, best_indices
