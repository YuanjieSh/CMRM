...
from corrupted_mini import corrupted_MiniImageNet
from utils import *
...
def main():
    ...
    if args.loss_type == 'CE_reg' or args.loss_type == 'Focal_reg' or args.loss_type == 'LDAM_reg':
        base_path = "dataset={}/architecture={}/loss_type={}/imb_type={}/imb_factor={}/reg={}/alpha={}/train_rule={}/epochs={}/batch-size={}\
        /lr={}/momentum={}/".format(args.dataset, args.arch, args.loss_type, args.imb_type, args.imb_factor, args.reg, args.alpha, args.train_rule,\
             args.epochs, args.batch_size, args.lr, args.momentum)
        args.store_name = '_'.join([args.dataset, args.arch, args.loss_type, args.train_rule, args.imb_type, str(args.imb_factor), args.exp_str, str(args.reg), str(args.alpha)])
    else:
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if (epoch + 1) % 50 == 0 and (epoch + 1) != args.epochs:

            epoch_path = "dataset={}/architecture={}/loss_type={}/noise_rho={}/train_rule={}/epochs={}/batch-size={}\
            ...
            epoch_model_dir = 'checkpoint/noise/' + epoch_path + args.store_name # include args.store_name in epoch_model_dir
