...
def main():
    ...
    args.root_log =  'log/noise/' + base_path
    args.root_model = 'checkpoint/noise/' + base_path
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    use_norm = True if args.loss_type in ['LDAM', 'CVAR_LDAM'] else False
    model = models.__dict__[args.arch](num_classes=num_classes, use_norm=use_norm)

    # print("Model linear layer shape:", model.linear.weight.shape)
    ...
    val_loader = torch.utils.data.DataLoader(
        val_dataset, batch_size=5000, shuffle=False,
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            # print("Checkpoint linear weight shape:", checkpoint['state_dict']['linear.weight'].shape)
            ...
            # base_path = "dataset={}/architecture={}/loss_type={}/imb_type={}/imb_factor={}/train_rule={}/start_epochs={}/epochs={}/batch-size={}\
            ...
            # args.store_name = '_'.join([args.dataset, args.arch, args.loss_type, args.train_rule, args.imb_type, str(args.imb_factor), args.exp_str])
            # args.root_log =  'log/fine_tune/' + base_path
            # args.root_model = 'checkpoint/fine_tune/' + base_path
            ...
            /lr={}/momentum={}/".format(args.dataset, args.arch, args.loss_type, args.noise_rho, args.reg, args.alpha, args.train_rule,\
                args.start_epoch, args.epochs, args.batch_size, args.lr, args.momentum)
            args.store_name = '_'.join([args.dataset, args.arch, args.loss_type, args.train_rule, str(args.noise_rho), args.exp_str, str(args.alpha)])
            args.root_log =  'log/fine_tune/' + base_path
            args.root_model = 'checkpoint/fine_tune/' + base_path
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        acc1, val_margin_logit, val_margin_prob = validate(val_loader, model, criterion, epoch, args, log_testing, tf_writer)
        ...
        if (epoch + 1) % 50 == 0:
            save_intermediate_checkpoint(args, epoch + 1, model, optimizer, best_acc1)
...
def validate(val_loader, model, criterion, epoch, args, log=None, tf_writer=None, flag='val'):
    ...
    #cls_test_4 = calc_top_k_accuracy_per_class(val_loader, model, args, 98)
    #print(cls_test_4)
