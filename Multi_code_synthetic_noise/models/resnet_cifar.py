...
__all__ = ['ResNet_s', 'resnet20', 'resnet32', 'resnet44', 'resnet50', 'resnet56', 'resnet110', 'resnet1202']
...
class Bottleneck(nn.Module):
    expansion = 4  # Typically, the expansion factor for bottleneck blocks is 4
...
def resnet50(num_classes=10, use_norm=False, features=3):
    # Number of blocks for each of the 4 layers in ResNet50
    num_blocks = [3, 4, 6, 3]  
    return ResNet_s(Bottleneck, num_blocks, num_classes=num_classes, use_norm=use_norm, features=features)
